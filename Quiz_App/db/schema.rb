...
ActiveRecord::Schema.define(version: 20170917131352) do
  ...
  create_table "statestores", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "genreName"
    t.string "subgenreName"
